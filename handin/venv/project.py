...
def Sentiment(pkl_name, *args):
    ...
    ''' Take the most frequent words in the neutral reviews from train dataset'''
...
def main():
    ...
    """ 2. Test Data: Remove words with frequency less than 1000  """
    Remove_Infrequent_Words(1000, datatype+"_basic_stop.pkl", True)
